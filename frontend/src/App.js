    ...
    >
      ...
      <div className="content">
        <div className="content">
          ...
          <ServerInfo backendURL={BACKEND} className="server-info" requirements={<Requirements items={[{ title: "Minecraft (Java): ", display: "v1.21.11", link: "https://www.minecraft.net/en-us/article/minecraft-java-edition-1-21-11"}, { title: "Rec. Modpack: ", display: "Fabric Modpack", link:"https://modrinth.com/modpack/ohne-schnickschnack"}]}/>} onStateChange={setSmpServerState} buttonName="Under Maintenance" serverName="SMP-Server" serverDescription="Want all the latest features? Jump into the worlds of the always-up-to-date fabric SMP."/>
        </div>
      </div>
